...
def generate_gtsam_heatmap():
    ...
    # Filter for GTSAM_Cold solver and M=150
    df = df[(df['solver'] == 'GTSAM_Cold') & (df['m_points'] == 150)]
    
    if df.empty:
        print("No data found for GTSAM_Cold M=150")
        return
